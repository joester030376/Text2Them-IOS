...
class StaffMemberViewHandler
{
    func GetHandler(id:Int,completion:@escaping (StaffMemberViewModel?, Error?)-> Void) {
     ...
     //   APIManager.callApi(API.EditOrganization.requestString(), param: param, method:.post,encodeType: URLEncoding.default, isLoader: true) { (code, error, data) in
        APIManager.callApi(API.View.requestString(),  param: param, method:.post, header: nil,encodeType: URLEncoding.default, isLoader: true) { (code, error, data) in
